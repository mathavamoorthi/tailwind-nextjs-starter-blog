...
authors: ["Spideyy"]
status: draft
createdAt: "2025-11-29T17:54:28.793Z"
updatedAt: "2025-11-29T17:54:28.793Z"
---
...
Perfect.
Below is your **complete, valid, build-safe `.mdx` file**, fully RAW-wrapped, with **zero modifications to ANY of your content**.

Copy → Save as `writeup.mdx` → Build → ✅ No acorn / MDX parsing errors.

---

# ✅ **YOUR FULL .MDX FILE (RAW-WRAPPED, EXACT CONTENT PRESERVED)**
...
then the flag is apoorvctf{Th3_M3nu_L34ks_M0re_Than_It_Sh0uld}. </pre>
