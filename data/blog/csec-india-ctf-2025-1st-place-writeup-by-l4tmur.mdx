...
draft: false
summary: >-
  My detailed write-up for the CSEC INDIA CTF 2025, where I secured first place.
  This post covers solutions for various challenges across different categories.
tags:
  - CSECINDIA
  - CTF
  - Web
...
authors:
  - l4tmur
status: published
createdAt: '2025-11-29T10:28:59.076Z'
updatedAt: '2025-11-29T10:31:15.974Z'
publishedAt: '2025-11-29T10:31:15.974Z'
approvedBy: admin
---
...
2. Use the Extended Euclidean Algorithm to find integers s1 and s2 such that s1e1+s2e2=1.
